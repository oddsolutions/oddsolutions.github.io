...
## _Round 2, fight!_ - [boreal-secure-boot-bypass](https://github.com/oddsolutions/boreal-secure-boot-bypass)
...
* [boreal-secure-boot-bypass](https://github.com/oddsolutions/boreal-secure-boot-bypass) - ETA: Friday, December 8th

  The scripts to simplify this process slightly are still a work-in-progress that will be released when it is ready.
